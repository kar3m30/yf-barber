...
function checkAuth() {
  ...
  if (isAuth) { initAdminData(); startAdminLiveRefresh(); setTimeout(startAutoQrScanner, 250); } else { stopAdminLiveRefresh(); }
}
...
function setupEvents() {
  ...
  document.getElementById('btn-logout')?.addEventListener('click', () => { closeQrScanner(); sessionStorage.removeItem('yf_admin_session'); checkAuth(); });
